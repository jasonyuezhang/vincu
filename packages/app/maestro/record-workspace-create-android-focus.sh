...
OUT_DIR="/tmp/vincu-workspace-create-android-focus-$(date +%s)"
VIDEO_DIR="/tmp/vincu-maestro-videos"
DEVICE_VIDEO="/sdcard/vincu-maestro-workspace-create-focused.mp4"
LOCAL_VIDEO="$VIDEO_DIR/vincu-maestro-workspace-create-focused.mp4"
