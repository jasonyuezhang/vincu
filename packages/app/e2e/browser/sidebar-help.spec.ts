...
const GITHUB_ISSUE_DESTINATION =
  /^https:\/\/github\.com\/(?:getvincu\/vincu\/issues\/new(?:\/choose)?(?:[/?#]|$)|login\?return_to=https%3A%2F%2Fgithub\.com%2Fgetvincu%2Fvincu%2Fissues%2Fnew$)/;
const CHANGELOG_DESTINATION = /^https:\/\/vincu\.sh\/changelog(?:[/?#]|$)/;
...
const APP_VERSION = /^Vincu\s*v\d+\.\d+\.\d+(?:-[0-9A-Za-z.-]+)?(?:\+[0-9A-Za-z.-]+)?$/;
