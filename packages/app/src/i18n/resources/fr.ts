...
export const fr: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "L'archive n'est pas disponible ici car cet espace de travail n'a pas été créé en tant qu'arbre de travailVincu",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "LaissezVincudémarrer et arrêter le démon intégré",
        ...
        pausedStopFailed:
          "La gestion du démon intégré a été suspendue, maisVincun'a ​​pas pu arrêter le démon.",
      ...
      keepRunning: {
        ...
        hint: "Daemoncontinue de fonctionner lorsque vous quittezVincu",
      },
      logs: {
      ...
      fullStatus: {
        ...
        hint: "Exécute`vincu daemon status`et affiche la sortie",
    ...
    rosetta: {
      ...
      runningIntel: "Vous exécutez la versionInteldeVincusousRosettasurApple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "Test de notificationVincu",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Impossible d'installer leVincuCLI.",
      },
      skills: {
  ...
  rootError: {
    ...
    title: "Vincu a rencontré un problème.",
  ...
  pairing: {
    ...
    direct: {
      title: "Connexion directe",
      helper: "Saisissez l'adresse d'un serveurVincu.",
      fields: {
        host: "Host",
        port: "Port",
    ...
    device: {
      ...
      relayDocsAccessibility: "Lire comment fonctionne le relais Vincu",
      ...
      updateRequired: "Mettez à jour l’hôte pour activer le relais depuis Vincu Desktop.",
      unavailable: "Offre de jumelage indisponible.",
      hint: "Scannez ce codeQRavecVincusur votre téléphone ou copiez le lien ci-dessous.",
  ...
  toolCallGroup: {
    ...
    vincuCalls: {
      one: "a appelé Vincu {{count}} fois",
      other: "a appelé Vincu {{count}} fois",
    },
    and: "et",
  },
  renameModal: {
  ...
  settings: {
    ...
    general: {
      ...
      browserData: {
        ...
        description:
          "Les onglets du navigateur partagent les connexions et les données des sites dans Vincu.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Cela met à jourVincusur cet ordinateur",
    ...
    integrations: {
      ...
      skills: {
        ...
        updateTitle: "Mettre à jour les compétencesVincu?",
        updateFallback: "Synchronisez les compétences regroupées sur votre machine.",
        uninstallTitle: "Désinstaller les compétencesVincu?",
        uninstallMessage:
          "Supprime toutes les compétences d'orchestrationVincude ~/.agents, ~/.claude, ~/.codex.",
    ...
    host: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Cet hôte est hors ligne.Vincuse reconnecte automatiquement: attendez qu'il soit de nouveau en ligne avant de redémarrer.",
          requestFailedTitle: "Erreur",
          requestFailedMessage:
            "Échec de l'envoi de la demande de redémarrage.Vincuse reconnecte automatiquement - réessayez une fois que l'hôte apparaît comme en ligne.",
          dialogFailedMessage:
            "Impossible d'ouvrir la boîte de dialogue de confirmation de redémarrage.",
        },
        update: {
          desktopManagedHint:
            "Ce daemon est géré par Vincu Desktop. Mettez à jour Vincu Desktop sur l’hôte.",
          title: "Update daemon",
    ...
    providers: {
      ...
      emptyList: "Ajoutez un fournisseur pour commencer.",
      builtinProviders: "Fournisseurs intégrés",
      catalogProviders: "Catalogue ACP",
      signInWithAccount: "Se connecter avec un compte",
      useApiKey: "Utiliser une clé API",
      apiKeyLabel: "Clé API",
      apiKeyPlaceholder: "Collez la clé API",
      apiKeySave: "Ajouter avec une clé API",
      apiKeyCancel: "Annuler",
      choosingAuth: "Comment {{name}} doit-il s’authentifier ?",
      addingInstance: "Ajout...",
      ...
      accounts: {
        ...
        addCursor: "Ajouter un compte Cursor",
        adding: "Adding...",
        login: "Log in",
        ...
        hostUpdateRequired:
          "Mettez à jour cet hôte pour gérer les comptes Claude, Codex et Cursor dans Vincu.",
      ...
      rename: {
        ...
        submit: "Enregistrer",
        errorTitle: "Impossible de renommer le fournisseur",
        doubleClickHint: "Double-cliquez pour renommer",
      },
      remove: {
      ...
      models: {
        ...
        setDefaultAction: "Définir",
        setDefault: "Définir {{id}} comme modèle par défaut",
        setDefaultFailed: "Impossible de définir le modèle par défaut",
      },
      diagnostic: {
        title: "Diagnostique",
        button: "Diagnostique",
    ...
    project: {
      ...
      readFailures: {
        invalidTitle: "vincu.json n'a pas pu être analysé",
        ...
        transportTitle: "Impossible de charger vincu.json",
        transportFallback: "L'hôte n'a pas répondu.",
        failedTitle: "Impossible de charger vincu.json",
      ...
      scripts: {
        ...
        serviceHint: "Vincusupervise le processus et attribue un port via $VINCU_PORT",
        actions: {
      ...
      metadata: {
        ...
        info: "Instructions spécifiques au projet injectées dans les invites de l'IA queVincuutilise pour générer des métadonnées: utilisez-les pour appliquer les conventions de votre équipe telles que la dénomination des branches, le style de validation ou le formatPR.",
      ...
      writeFailures: {
        ...
        staleDescription: "Rechargez pour récupérer le dernier vincu.json avant de sauvegarder.",
        failedTitle: "Impossible d'enregistrer vincu.json",
