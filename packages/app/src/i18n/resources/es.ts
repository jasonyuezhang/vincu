...
export const es: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "El archivo no está disponible aquí porque este espacio de trabajo no se creó como un árbol de trabajoVincu",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Deje queVincuinicie y detenga el demonio incorporado",
        ...
        pausedStopFailed:
          "La gestión del demonio integrado se pausó, peroVincuno pudo detener el demonio.",
      ...
      keepRunning: {
        ...
        hint: "Daemonsigue ejecutándose cuando sales deVincu",
      },
      logs: {
      ...
      fullStatus: {
        ...
        hint: "Ejecuta`vincu daemon status`y muestra la salida.",
        view: "Ver estado",
    ...
    rosetta: {
      ...
      runningIntel: "Estás ejecutando la compilaciónInteldeVincuenRosettaenApple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "Prueba de notificaciónVincu",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "No se puede instalar elVincuCLI.",
      },
      skills: {
  ...
  pairing: {
    ...
    direct: {
      title: "Conexión directa",
      helper: "Ingrese la dirección de un servidorVincu.",
      fields: {
        host: "Host",
        port: "Puerto",
        password: "Contraseña",
    ...
    device: {
      ...
      relayDocsAccessibility: "Leer cómo funciona el relé de Vincu",
      ...
      updateRequired: "Actualice el host para habilitar el relé desde Vincu Desktop.",
      unavailable: "Oferta de maridaje no disponible.",
      hint: "Escanee este códigoQRconVincuen su teléfono o copie el enlace a continuación.",
  ...
  toolCallGroup: {
    ...
    vincuCalls: {
      one: "llamó a Vincu {{count}} vez",
      other: "llamó a Vincu {{count}} veces",
    },
    and: "y",
  },
  renameModal: {
  ...
  settings: {
    ...
    general: {
      ...
      browserData: {
        ...
        description:
          "Las pestañas del navegador comparten inicios de sesión y datos de sitios en Vincu.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Esto actualizaVincuen esta computadora.",
    ...
    integrations: {
      ...
      skills: {
        ...
        updateTitle: "¿Actualizar las habilidades deVincu?",
        updateFallback: "Sincronice las habilidades incluidas con su máquina.",
        uninstallTitle: "¿Desinstalar las habilidadesVincu?",
        uninstallMessage:
          "Elimina todas las habilidades de orquestaciónVincude ~/.agents, ~/.claude, ~/.codex.",
    ...
    host: {
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Habilitar herramientasVincu",
          hint: "Los agentes podrán gestionar árboles de trabajo, agentes y horarios.",
          accessibilityLabel: "Inyectar herramientasVincu",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Este anfitrión está desconectado.Vincuse vuelve a conectar automáticamente; espere hasta que vuelva a estar en línea antes de reiniciar.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "No se pudo enviar la solicitud de reinicio.Vincuse vuelve a conectar automáticamente; inténtelo nuevamente una vez que el host se muestre en línea.",
          dialogFailedMessage:
            "No se puede abrir el cuadro de diálogo de confirmación de reinicio.",
        },
        update: {
          desktopManagedHint:
            "Este daemon está administrado por Vincu Desktop. Actualiza Vincu Desktop en el host.",
          title: "Update daemon",
    ...
    providers: {
      ...
      emptyList: "Agrega un proveedor para empezar.",
      builtinProviders: "Proveedores integrados",
      catalogProviders: "Catálogo ACP",
      signInWithAccount: "Iniciar sesión con cuenta",
      useApiKey: "Usar clave API",
      apiKeyLabel: "Clave API",
      apiKeyPlaceholder: "Pega la clave API",
      apiKeySave: "Agregar con clave API",
      apiKeyCancel: "Cancelar",
      choosingAuth: "¿Cómo debería autenticarse {{name}}?",
      addingInstance: "Agregando...",
      ...
      accounts: {
        ...
        addCursor: "Agregar cuenta de Cursor",
        adding: "Adding...",
        login: "Log in",
        ...
        hostUpdateRequired:
          "Actualiza este host para gestionar cuentas de Claude, Codex y Cursor en Vincu.",
      ...
      rename: {
        ...
        submit: "Guardar",
        errorTitle: "No se pudo renombrar el proveedor",
        doubleClickHint: "Haz doble clic para renombrar",
      },
      remove: {
      ...
      models: {
        ...
        setDefaultAction: "Predeterminar",
        setDefault: "Establecer {{id}} como modelo predeterminado",
        setDefaultFailed: "No se pudo establecer el modelo predeterminado",
      },
      diagnostic: {
        title: "Diagnóstico",
        button: "Diagnóstico",
    ...
    project: {
      ...
      readFailures: {
        invalidTitle: "vincu.json no se pudo analizar",
        ...
        transportTitle: "No se pudo cargar vincu.json",
        transportFallback: "El anfitrión no respondió.",
        failedTitle: "No se pudo cargar vincu.json",
      ...
      scripts: {
        ...
        serviceHint: "Vincusupervisa el proceso y asigna un puerto vía $VINCU_PORT",
        actions: {
          add: "Agregar guión",
          edit: "Editar",
          remove: "Eliminar",
      ...
      metadata: {
        ...
        info: "Instrucciones específicas del proyecto inyectadas en los mensajes de IA queVincuutiliza para generar metadatos; úselas para hacer cumplir las convenciones de su equipo, como la denominación de ramas, el estilo de confirmación o el formatoPR.",
      ...
      writeFailures: {
        ...
        staleDescription: "Vuelva a cargar para obtener el último vincu.json antes de guardar.",
        failedTitle: "No se pudo guardar vincu.json",
