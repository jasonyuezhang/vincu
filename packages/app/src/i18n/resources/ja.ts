...
export const ja: TranslationResources = {
  ...
  settings: {
    ...
    providers: {
      ...
      emptyList: "プロバイダーを追加して始めましょう。",
      builtinProviders: "組み込みプロバイダー",
      catalogProviders: "ACP カタログ",
      signInWithAccount: "アカウントでサインイン",
      useApiKey: "API キーを使用",
      apiKeyLabel: "API キー",
      apiKeyPlaceholder: "API キーを貼り付け",
      apiKeySave: "API キーで追加",
      apiKeyCancel: "キャンセル",
      choosingAuth: "{{name}} の認証方法は？",
      addingInstance: "追加中...",
      ...
      accounts: {
        ...
        hostUpdateRequired:
          "Vincu で Claude、Codex、Cursor アカウントを管理するには、このホストを更新してください。",
      ...
      rename: {
        title: "プロバイダー名を変更",
        submit: "保存",
        errorTitle: "プロバイダー名を変更できません",
        doubleClickHint: "ダブルクリックで名前を変更",
      },
      remove: {
      ...
      models: {
        ...
        updated: "{{time}}に更新",
        defaultBadge: "デフォルト",
        setDefaultAction: "デフォルトに設定",
        setDefault: "{{id}} をデフォルトモデルに設定",
        setDefaultFailed: "デフォルトモデルを設定できませんでした",
      },
      diagnostic: {
        title: "診断",
        button: "診断",
