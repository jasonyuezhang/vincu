...
export const ptBR: TranslationResources = {
  ...
  settings: {
    ...
    providers: {
      ...
      emptyList: "Adicione um provedor para começar.",
      builtinProviders: "Provedores integrados",
      catalogProviders: "Catálogo ACP",
      signInWithAccount: "Entrar com conta",
      useApiKey: "Usar chave de API",
      apiKeyLabel: "Chave de API",
      apiKeyPlaceholder: "Cole a chave de API",
      apiKeySave: "Adicionar com chave de API",
      apiKeyCancel: "Cancelar",
      choosingAuth: "Como {{name}} deve autenticar?",
      addingInstance: "Adicionando...",
      ...
      accounts: {
        ...
        addCursor: "Adicionar conta Cursor",
        adding: "Adding...",
        login: "Log in",
        ...
        hostUpdateRequired:
          "Atualize este host para gerenciar contas Claude, Codex e Cursor no Vincu.",
      ...
      rename: {
        title: "Renomear provedor",
        submit: "Salvar",
        errorTitle: "Não foi possível renomear o provedor",
        doubleClickHint: "Clique duas vezes para renomear",
      },
      remove: {
      ...
      models: {
        ...
        defaultBadge: "Padrão",
        setDefaultAction: "Definir padrão",
        setDefault: "Definir {{id}} como modelo padrão",
        setDefaultFailed: "Falha ao definir o modelo padrão",
      },
      diagnostic: {
        title: "Diagnóstico",
        button: "Diagnóstico",
