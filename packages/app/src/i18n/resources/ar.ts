...
export const ar: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "الأرشيف غير متاح هنا لأنه لم يتم إنشاء مساحة العمل هذه كشجرة عمل Vincu",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "اسمح لـ Vincu ببدء تشغيل البرنامج الخفي المدمج وإيقافه",
        ...
        pausedStopFailed:
          "تم إيقاف إدارة البرنامج الخفي المضمنة مؤقتًا، لكن لم يتمكن Vincu من إيقاف البرنامج الخفي.",
        updateFailed: "غير قادر على تحديث إدارة البرنامج الخفي المضمنة.",
      },
      keepRunning: {
        title: "استمر في تشغيل البرنامج الخفي بعد الإقلاع عن التدخين",
        hint: "يستمر تشغيل Daemon عند إنهاء Vincu",
      },
      logs: {
        title: "ملف السجل",
      ...
      fullStatus: {
        ...
        hint: "يقوم بتشغيل`vincu daemon status`ويظهر الإخراج",
        view: "عرض الحالة",
    ...
    rosetta: {
      ...
      runningIntel: "أنت تقوم بتشغيل إصدار Intel من Vincu ضمن Rosetta على Apple Silicon.",
      highCpu:
    ...
    integrations: {
      cli: {
        ...
        installFailed: "غير قادر على تثبيت VincuCLI.",
      },
      skills: {
  ...
  pairing: {
    ...
    device: {
      ...
      relayDocsAccessibility: "اقرأ كيفية عمل تتابع Vincu",
      ...
      updateRequired: "حدّث المضيف لتمكين التتابع من Vincu Desktop.",
      unavailable: "عرض الاقتران غير متاح.",
      hint: "قم بمسح رمز QR هذا باستخدام Vincu على هاتفك، أو انسخ الرابط أدناه.",
  ...
  toolCallGroup: {
    ...
    vincuCalls: {
      one: "استدعى Vincu {{count}} مرة",
      other: "استدعى Vincu {{count}} مرات",
    },
    and: "و",
  },
  renameModal: {
  ...
  settings: {
    ...
    general: {
      ...
      browserData: {
        ...
        description: "تتشارك علامات تبويب المتصفح تسجيلات الدخول وبيانات المواقع عبر Vincu.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "يؤدي هذا إلى تحديث Vincu على هذا الكمبيوتر",
    ...
    integrations: {
      ...
      skills: {
        ...
        updateTitle: "تحديث مهارات Vincu ؟",
        updateFallback: "مزامنة المهارات المجمعة لجهازك.",
        uninstallTitle: "إلغاء تثبيت مهارات Vincu ؟",
        uninstallMessage: "يزيل جميع مهارات تنسيق Vincu من ~/.agents ، ~/.claude ، ~/.codex.",
    ...
    host: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "هذا المضيف غير متصل.  يقوم Vincu بإعادة الاتصال تلقائيًا - انتظر حتى يتم الاتصال بالإنترنت مرة أخرى قبل إعادة التشغيل.",
          requestFailedTitle: "خطأ",
          requestFailedMessage:
            "فشل في إرسال طلب إعادة التشغيل.  يقوم Vincu بإعادة الاتصال تلقائيًا - حاول مرة أخرى بمجرد ظهور المضيف على أنه متصل بالإنترنت.",
          dialogFailedMessage: "غير قادر على فتح مربع حوار تأكيد إعادة التشغيل.",
        },
        update: {
          desktopManagedHint:
            "يدير Vincu Desktop هذا البرنامج الخفي. حدّث Vincu Desktop على المضيف.",
          title: "Update daemon",
    ...
    providers: {
      ...
      emptyList: "أضف مزودًا للبدء.",
      builtinProviders: "المزودون المدمجون",
      catalogProviders: "كتالوج ACP",
      signInWithAccount: "تسجيل الدخول بالحساب",
      useApiKey: "استخدام مفتاح API",
      apiKeyLabel: "مفتاح API",
      apiKeyPlaceholder: "الصق مفتاح API",
      apiKeySave: "إضافة بمفتاح API",
      apiKeyCancel: "إلغاء",
      choosingAuth: "كيف يجب أن يصادق {{name}}؟",
      addingInstance: "جارٍ الإضافة...",
      ...
      accounts: {
        ...
        hostUpdateRequired: "حدّث هذا المضيف لإدارة حسابات Claude وCodex وCursor في Vincu.",
      ...
      rename: {
        title: "إعادة تسمية المزود",
        submit: "حفظ",
        errorTitle: "تعذر إعادة تسمية المزود",
      ...
      models: {
        ...
        setDefault: "Set {{id}} as default model",
    ...
    project: {
      ...
      readFailures: {
        invalidTitle: "تعذر تحليل vincu.json",
        ...
        transportTitle: "تعذر تحميل vincu.json",
        transportFallback: "المضيف لم يستجب.",
        failedTitle: "تعذر تحميل vincu.json",
      ...
      scripts: {
        ...
        serviceHint: "يشرف Vincu على العملية ويعين منفذًا عبر $VINCU_PORT",
        actions: {
      ...
      metadata: {
        ...
        info: "تعليمات خاصة بالمشروع يتم إدخالها في الذكاء الاصطناعي الذي يستخدمه Vincu لإنشاء بيانات التعريف - استخدمها لفرض اصطلاحات فريقك مثل تسمية الفرع أو نمط الالتزام أو تنسيق PR",
      ...
      writeFailures: {
        ...
        staleDescription: "أعد التحميل لجلب أحدث ملف vincu.json قبل الحفظ.",
        failedTitle: "تعذر حفظ vincu.json",
