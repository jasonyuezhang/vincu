...
export const ko: TranslationResources = {
  ...
  settings: {
    ...
    providers: {
      ...
      emptyList: "시작하려면 프로바이더를 추가하세요.",
      builtinProviders: "기본 프로바이더",
      catalogProviders: "ACP 카탈로그",
      signInWithAccount: "계정으로 로그인",
      useApiKey: "API 키 사용",
      apiKeyLabel: "API 키",
      apiKeyPlaceholder: "API 키 붙여넣기",
      apiKeySave: "API 키로 추가",
      apiKeyCancel: "취소",
      choosingAuth: "{{name}} 인증 방법을 선택하세요",
      addingInstance: "추가 중...",
      ...
      accounts: {
        ...
        hostUpdateRequired:
          "Vincu에서 Claude, Codex, Cursor 계정을 관리하려면 이 호스트를 업데이트하세요.",
      ...
      rename: {
        title: "프로바이더 이름 변경",
        submit: "저장",
        errorTitle: "프로바이더 이름을 변경할 수 없습니다",
        doubleClickHint: "두 번 클릭하여 이름 변경",
      },
      remove: {
      ...
      models: {
        ...
        updated: "{{time}} 업데이트됨",
        defaultBadge: "기본값",
        setDefaultAction: "기본값으로 설정",
        setDefault: "{{id}}을(를) 기본 모델로 설정",
        setDefaultFailed: "기본 모델을 설정하지 못했습니다",
      },
      diagnostic: {
        title: "진단",
        button: "진단",
