export const en = {
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Let Vincu start and stop the built-in daemon",
        ...
        pausedStopFailed:
          "Built-in daemon management was paused, but Vincu could not stop the daemon.",
        updateFailed: "Unable to update built-in daemon management.",
      },
      keepRunning: {
        title: "Keep daemon running after quit",
        hint: "Daemon keeps running when you quit Vincu",
      },
      logs: {
        title: "Log file",
      ...
      fullStatus: {
        ...
        hint: "Runs `vincu daemon status` and shows the output",
        view: "View status",
    ...
    rosetta: {
      ...
      runningIntel: "You're running the Intel build of Vincu under Rosetta on Apple Silicon.",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Unable to install the Vincu CLI.",
      },
      skills: {
  ...
  rootError: {
    ...
    title: "Vincu ran into a problem.",
  ...
  pairing: {
    ...
    direct: {
      title: "Direct connection",
      helper: "Enter the address of a Vincu server.",
      fields: {
        host: "Host",
        port: "Port",
        password: "Password",
    ...
    device: {
      ...
      relayDocsAccessibility: "Read how Vincu relay works",
      ...
      updateRequired: "Update the host to enable relay from Vincu Desktop.",
      unavailable: "Pairing offer unavailable.",
      hint: "Scan this QR code with Vincu on your phone, or copy the link below.",
  ...
  toolCallGroup: {
    ...
    vincuCalls: {
      one: "called Vincu {{count}} time",
      other: "called Vincu {{count}} times",
    },
    and: "and",
  },
  renameModal: {
  ...
  settings: {
    ...
    general: {
      ...
      browserData: {
        ...
        description: "Browser tabs share sign-ins and site data across Vincu.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "This updates Vincu on this computer",
    ...
    integrations: {
      ...
      skills: {
        ...
        updateTitle: "Update Vincu skills?",
        updateFallback: "Sync bundled skills to your machine.",
        uninstallTitle: "Uninstall Vincu skills?",
        uninstallMessage:
          "Removes all Vincu orchestration skills from ~/.agents, ~/.claude, ~/.codex.",
    ...
    host: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "This host is offline. Vincu reconnects automatically-wait until it's back online before restarting.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "Failed to send the restart request. Vincu reconnects automatically-try again once the host shows as online.",
    ...
    providers: {
      ...
      emptyList: "Add a provider to get started.",
      builtinProviders: "Built-in providers",
      catalogProviders: "ACP catalog",
      signInWithAccount: "Sign in with account",
      useApiKey: "Use API key",
      apiKeyLabel: "API key",
      apiKeyPlaceholder: "Paste API key",
      apiKeySave: "Add with API key",
      apiKeyCancel: "Cancel",
      choosingAuth: "How should {{name}} authenticate?",
      ...
      accounts: {
        ...
        hostUpdateRequired:
          "Update this host to manage Claude, Codex, and Cursor accounts in Vincu.",
      ...
      rename: {
        ...
        submit: "Save",
        errorTitle: "Unable to rename provider",
    ...
    project: {
      ...
      readFailures: {
        invalidTitle: "vincu.json couldn't be parsed",
        ...
        transportTitle: "Couldn't load vincu.json",
        transportFallback: "The host didn't respond.",
        failedTitle: "Couldn't load vincu.json",
      ...
      scripts: {
        ...
        serviceHint: "Vincu supervises the process and assigns a port via $VINCU_PORT",
        actions: {
          add: "Add script",
          edit: "Edit",
          remove: "Remove",
      ...
      metadata: {
        ...
        info: "Project-specific instructions injected into the AI prompts Vincu uses to generate metadata - use them to enforce your team's conventions like branch naming, commit style, or PR format",
      ...
      writeFailures: {
        ...
        staleDescription: "Reload to fetch the latest vincu.json before saving.",
        failedTitle: "Couldn't save vincu.json",
