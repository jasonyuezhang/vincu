...
export const ru: TranslationResources = {
  ...
  settings: {
    ...
    providers: {
      ...
      emptyList: "Добавьте провайдера, чтобы начать.",
      builtinProviders: "Встроенные провайдеры",
      catalogProviders: "Каталог ACP",
      signInWithAccount: "Войти через аккаунт",
      useApiKey: "Использовать API-ключ",
      apiKeyLabel: "API-ключ",
      apiKeyPlaceholder: "Вставьте API-ключ",
      apiKeySave: "Добавить с API-ключом",
      apiKeyCancel: "Отмена",
      choosingAuth: "Как должен аутентифицироваться {{name}}?",
      addingInstance: "Добавление...",
      ...
      accounts: {
        ...
        addCursor: "Добавить аккаунт Cursor",
        adding: "Adding...",
        login: "Log in",
        ...
        hostUpdateRequired:
          "Обновите этот хост, чтобы управлять аккаунтами Claude, Codex и Cursor в Vincu.",
      ...
      rename: {
        title: "Переименовать провайдера",
        submit: "Сохранить",
        errorTitle: "Не удалось переименовать провайдера",
        doubleClickHint: "Дважды щёлкните, чтобы переименовать",
      },
      remove: {
      ...
      models: {
        ...
        setDefaultAction: "Сделать основным",
        setDefault: "Сделать {{id}} моделью по умолчанию",
        setDefaultFailed: "Не удалось задать модель по умолчанию",
      },
      diagnostic: {
        title: "Диагностика",
        button: "Диагностика",
