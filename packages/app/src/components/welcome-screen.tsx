...
export function WelcomeScreen({ onHostAdded }: WelcomeScreenProps) {
  ...
  const handleOpenVincuSite = useCallback(() => {
    void openExternalUrl("https://vincu.sh");
  }, []);
      ...
      >
        <View style={styles.content}>
          ...
          <View style={styles.copyBlock}>
            ...
            {isNative ? (
              <Pressable style={styles.setupLink} onPress={handleOpenVincuSite}>
                <Text style={styles.setupLinkText}>vincu.sh</Text>
