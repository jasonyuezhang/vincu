...
import type { SessionInboundMessage, SessionOutboundMessage } from "@getvincu/protocol/messages";
...
describe("mountBrowserAutomationHandler", () => {
  ...
  test("unimplemented preload IPC reports browser_unsupported", async () => {
    ...
    browser.browser.thrownError = new Error(
      'No handler registered for "vincu:browser:execute-automation-command"',
    );
    browser.mount();
