...
describe("parseAssistantFileLink", () => {
  ...
  it("keeps tilde hrefs as direct home-relative file targets", () => {
    expect(
      parseAssistantFileLink("~/.vincu/plans/file-preview.md", {
        workspaceRoot: "/Users/test/project",
      }),
    ).toEqual({
    ...
    expect(
      parseAssistantFileLink("~/.vincu/plans/file-preview.md:12", {
        workspaceRoot: "/Users/test/project",
      }),
    ).toEqual({
      raw: "~/.vincu/plans/file-preview.md:12",
      path: "~/.vincu/plans/file-preview.md",
      lineStart: 12,
      lineEnd: undefined,
    });
...
describe("normalizeInlinePathTarget", () => {
  ...
  it("keeps tilde paths as home-relative file targets", () => {
    expect(
      normalizeInlinePathTarget("~/.vincu/plans/file-preview.md", "/Users/test/project"),
    ).toEqual({
      directory: "~/.vincu/plans",
      file: "~/.vincu/plans/file-preview.md",
    });
  });
