import type { ToolCallDetail, ToolCallIconName } from "@getvincu/protocol/agent-types";
import { isVincuToolName } from "@getvincu/protocol/tool-name-normalization";

export type ToolCallIcon = ToolCallIconName | "vincu";
