...
describe("shortenPath", () => {
  it("shortens a macOS home directory path", () => {
    expect(shortenPath("/Users/moboudra/dev/vincu")).toBe("~/dev/vincu");
  });

  it("shortens a Linux home directory path", () => {
    expect(shortenPath("/home/moboudra/dev/vincu")).toBe("~/dev/vincu");
  });
  ...
  it("leaves Windows paths unchanged", () => {
    expect(shortenPath("C:\\Users\\moboudra\\dev\\vincu")).toBe("C:\\Users\\moboudra\\dev\\vincu");
  });
