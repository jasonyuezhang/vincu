...
import type { TerminalInputModeState } from "@getvincu/protocol/terminal-input-mode";
...
declare global {
  interface Window {
    ...
    __VINCU_TERMINAL_WEBVIEW_RECEIVE__?: (message: InboundMessage) => void;
    __VINCU_TERMINAL_WEBVIEW_BLUR__?: () => void;
  }
}
...
const TERMINAL_BACKGROUND_CSS_VAR = "--vincu-terminal-background";
...
window.__VINCU_TERMINAL_WEBVIEW_RECEIVE__ = bridge.receive;
window.__VINCU_TERMINAL_WEBVIEW_BLUR__ = bridge.blur;
