...
import type { VincuSubagentRow, ProviderSubagentRow, SubagentRow } from "./select";
import {
...
function row(
  overrides: Partial<VincuSubagentRow> & Pick<VincuSubagentRow, "id">,
): VincuSubagentRow {
  return {
    kind: "vincu",
    id: overrides.id,
