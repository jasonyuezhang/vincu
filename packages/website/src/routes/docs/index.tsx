...
export const Route = createFileRoute("/docs/")({
  head: () => {
    ...
    if (!doc)
      return pageMeta(
        "Docs - Vincu",
        "Install Vincu and start running coding agents from your phone, desktop, and terminal.",
        "/docs",
      );
    return pageMeta(`${doc.frontmatter.title} - Vincu Docs`, doc.frontmatter.description, "/docs");
  },
  component: DocsIndex,
});
