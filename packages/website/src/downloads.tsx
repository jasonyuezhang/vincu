...
export function releaseBase(version: string) {
  return `https://github.com/getvincu/vincu/releases/download/v${version}`;
}
...
export function downloadUrls(release: ReleaseAssetInfo) {
  ...
  return {
    macAppleSilicon: `${base}/Vincu-${version}-arm64.dmg`,
    macIntel: `${base}/Vincu-${version}-x64.dmg`,
    linuxAppImage: `${base}/${linuxAppImageAsset}`,
    linuxDeb: `${base}/Vincu-${version}-amd64.deb`,
    linuxRpm: `${base}/Vincu-${version}-x86_64.rpm`,
    windowsExeX64: `${base}/${windowsX64Asset ?? `Vincu-Setup-${version}.exe`}`,
    windowsExeArm64: windowsArm64Asset ? `${base}/${windowsArm64Asset}` : null,
    androidApk: `${base}/vincu-v${version}-android.apk`,
  };
}

export const appStoreUrl = "https://apps.apple.com/app/vincu-pocket-engineer/id6758887924";
export const playStoreUrl = "https://play.google.com/store/apps/details?id=sh.vincu";
export const webAppUrl = "https://app.vincu.sh";
