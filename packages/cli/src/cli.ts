...
export function createCli(): Command {
  ...
  program
    .name("vincu")
    .description("Vincu CLI - control your AI coding agents from the command line")
  ...
  addJsonAndDaemonHostOptions(
    program
      .command("clone")
      .description("Clone a GitHub repo and register it as a Vincu workspace")
  ...
  addJsonOption(
    program
      .command("status")
      .description('Show local daemon status (alias for "vincu daemon status")'),
  )
  ...
  addJsonOption(
    program
      .command("restart")
      .description('Restart local daemon (alias for "vincu daemon restart")'),
  )
    .option("--home <path>", "Vincu home directory (default: ~/.vincu)")
