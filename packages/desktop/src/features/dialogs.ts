...
export function registerDialogHandlers(): void {
  ipcMain.handle("vincu:dialog:ask", async (event, message: string, options?: AskOptions) => {
  ...
  ipcMain.handle("vincu:dialog:open", async (event, options?: OpenOptions) => {
    const win = BrowserWindow.fromWebContents(event.sender);
