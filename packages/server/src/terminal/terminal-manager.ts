...
import { deriveTerminalActivityStatusBucket } from "@getvincu/protocol/terminal-activity";
  ...
  return {
    ...
    async createTerminal(options: {
      ...
      const activityEnv = {
        ...
        VINCU_ACTIVITY_TOKEN: activityToken,
        ...(terminalActivityUrl ? { VINCU_TERMINAL_ACTIVITY_URL: terminalActivityUrl } : {}),
      };
