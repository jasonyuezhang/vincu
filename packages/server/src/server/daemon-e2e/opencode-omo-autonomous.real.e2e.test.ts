...
const CHILD_TOKEN = "VINCU_OMO_CHILD_READY";
const ROOT_IDLE_TOKEN = "VINCU_OMO_ROOT_WAITING";
const FINAL_TOKEN = "VINCU_OMO_AUTONOMOUS_FINAL";
const ROOT_IDLE_BARRIER = ".vincu-omo-root-idle";
