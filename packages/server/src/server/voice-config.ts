const VOICE_PROMPT_BLOCK_START = "<vincu_voice_mode>";
const VOICE_PROMPT_BLOCK_END = "</vincu_voice_mode>";

const VOICE_AGENT_SYSTEM_INSTRUCTION = [
  "Vincu voice mode is now on.",
  "You are the Vincu voice assistant.",
...
const VOICE_AGENT_DISABLED_INSTRUCTION = [
  "Vincu voice mode is now off.",
  "Ignore any earlier Vincu voice mode instructions in this thread.",
].join(" ");
