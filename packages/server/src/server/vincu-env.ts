...
export type VincuNodeEnv = "development" | "production" | "test";
...
export function createVincuInternalEnv(baseEnv: NodeJS.ProcessEnv): NodeJS.ProcessEnv {
...
export function resolveVincuNodeEnv(env: NodeJS.ProcessEnv): VincuNodeEnv | undefined {
  const value = env[VINCU_NODE_ENV];
