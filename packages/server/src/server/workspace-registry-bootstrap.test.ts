...
describe("bootstrapWorkspaceRegistries", () => {
  ...
  beforeEach(() => {
    ...
    vincuHome = path.join(tmpDir, ".vincu");
    agentStorage = new AgentStorage(path.join(vincuHome, "agents"), logger);
    projectRegistry = new FileBackedProjectRegistry(
      path.join(vincuHome, "projects", "projects.json"),
      logger,
    );
    workspaceRegistry = new FileBackedWorkspaceRegistry(
      path.join(vincuHome, "projects", "workspaces.json"),
      logger,
    );
