...
import { createExternalProcessEnv, type ProcessEnvRecord } from "../vincu-env.js";
export {
...
} from "@getvincu/protocol/provider-config";
import {
  ProviderOverrideSchema,
  ProviderOverridesSchema,
  ProviderRuntimeSettingsSchema,
...
// launched from inside Claude Code (e.g. by a Vincu agent), these leak into
