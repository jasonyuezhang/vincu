...
import type { VincuToolDefinition, VincuToolResult } from "./types.js";
...
export function addModelVisibleStructuredContent(result: VincuToolResult): VincuToolResult {
...
export function serializeVincuToolInputParameters(
  tool: VincuToolDefinition,
