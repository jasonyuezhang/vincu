...
import type { CreateVincuWorktreeInput } from "../../vincu-worktree-service.js";
import { expandUserPath, resolvePathFromBase } from "../../path-utils.js";
import { toWorktreeRequestError } from "../../worktree-errors.js";
import type {
  AgentWorktreeSetupContinuation,
  CreateVincuWorktreeSetupContinuationInput,
  CreateVincuWorktreeWorkflowFn,
  CreateVincuWorktreeWorkflowResult,
...
export interface CreateAgentFromMcpInput {
  ...
  onWorktreeCreated?: (createdWorktree: CreateVincuWorktreeWorkflowResult) => void;
...
export interface CreateAgentCommandResult {
  ...
  createdWorktree?: CreateVincuWorktreeWorkflowResult;
}
...
async function resolveMcpCwd(params: {
  ...
  const createdWorktree = await createMcpWorktree({
    ...
    createVincuWorktree: dependencies.createVincuWorktree,
...
interface CreateMcpWorktreeOptions {
  ...
  createVincuWorktree: CreateVincuWorktreeWorkflowFn | undefined;
...
async function createMcpWorktree(
  ...
  try {
    if (!options.createVincuWorktree) {
      throw new Error("Vincu worktree service is not configured");
    }
    return await options.createVincuWorktree(options.input, {
