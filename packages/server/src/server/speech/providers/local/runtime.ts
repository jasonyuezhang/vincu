...
import type { VincuSpeechConfig } from "../../../bootstrap.js";
...
function resolveConfiguredLocalModels(speechConfig: VincuSpeechConfig | null): ResolvedLocalModels {
  return {
...
export function getLocalSpeechAvailability(
  speechConfig: VincuSpeechConfig | null,
