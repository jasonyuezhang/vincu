import { readVincuConfigJson } from "./vincu-config-file.js";
import {
  VincuConfigSchema,
...
// owner replaces it wholesale via vincu.json metadataGeneration.<configKey>.instructions
...
async function readProjectMetadataOverrides(
...
): Promise<VincuMetadataGeneration | undefined> {
  ...
  try {
    ...
    return VincuConfigSchema.parse(json).metadataGeneration;
  } catch {
    return undefined;
  }
}
