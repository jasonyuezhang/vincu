...
describe("shouldUseTlsForDefaultHostedRelay", () => {
  test("returns true for the hosted Vincu relay on port 443", () => {
    expect(shouldUseTlsForDefaultHostedRelay("relay.vincu.sh:443")).toBe(true);
  });
