# Adding a Git Forge to Vincu

Vincu's forge layer is a registry/manifest system. A forge is a runtime concern:
...
allowlist. Self-hosted detection is a trust gate: Vincu only talks to a forge
